# Graph Report - Planify  (2026-07-15)

## Corpus Check
- 114 files · ~51,998 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 708 nodes · 1211 edges · 58 communities (36 shown, 22 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 133 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `269d555c`
...
Cohesion: 0.08
Nodes (30): ForgotPasswordPage(), LoginForm(), SetPasswordForm(), SignupPage(), AppEntryCta(), AppEntryCtaProps, AuthShell(), ChangePasswordOtpForm() (+22 more)
...
Cohesion: 0.15
Nodes (23): Comment, ReportsPage(), SAMPLE_COMMENTS, Version, assetAccent(), assetIcon(), AssetsView(), AssetsViewProps (+15 more)
...
Cohesion: 0.07
Nodes (57): AsyncIOMotorDatabase, get_database(), complete_signup(), get_me(), BaseModel, Request, update_workspace(), UpdateWorkspaceRequest (+49 more)
...
### Community 39 - "report_generator_node"
Cohesion: 0.27
Nodes (9): _normalize(), nodes/report_generator.py -------------------------- Universal report generator, Infer the primary report type from the user's message phrasing., Choose which report to generate this turn.      Priority:       1. Explicit matc, Universal report generator — trusts whatever the project_workflow LLM queued., _report_from_user_text(), report_generator_node(), _select_report_type() (+1 more)
...
### Community 55 - "route_after_project_workflow"
Cohesion: 0.29
...
### Community 72 - "conversation_understanding_node"
Cohesion: 0.40
...
## Knowledge Gaps
- **114 isolated node(s):** `handler`, `NavView`, `geistSans`, `geistMono`, `metadata` (+109 more)
...
- **Why does `project_workflow_node()` connect `project_workflow_node` to `Logging Config`, `apply_workflow_guards`, `get_graph`, `Request`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `Logging Config` to `ObjectId`, `Health Tests`, `DB Check Script`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `apply_workflow_guards()` connect `apply_workflow_guards` to `Auth Middleware`, `project_workflow_node`?**
